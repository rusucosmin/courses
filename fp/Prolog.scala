...
object Test extends App {
  ...
  // This shows how the DSL for Prolog embedded in Scala works
  // and highlights some differences with Prolog.

  // We explicitly introduce each predicate we plan to use
